...
public extension UICollectionView {
    ...
    public func dequeueSupplementaryView<T: UICollectionReusableView>(_ view: T.Type, ofKind kind: String = UICollectionElementKindSectionHeader, indexPath: IndexPath) -> T {
